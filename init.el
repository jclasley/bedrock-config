...
(custom-set-variables
 ...
 '(package-selected-packages
   '(apheleia flycheck-golangci-lint consult-lsp lsp-ui dracula-theme company use-package use-package-chords key-chord evil which-key))
...
(custom-set-faces
 ...
 '(match ((t (:background "light green" :foreground "#282a36"))))
