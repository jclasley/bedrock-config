...
** General
[[https://github.com/noctuid/general.el?tab=readme-ov-file#about][Reference]]
...
All theme configurations have been moved to themes.el
#+begin_src elisp
  (load-file (expand-file-name "~/emacs/bedrock-config/themes.el"))
#+end_src
...
#+begin_src elisp
  (use-package avy
    ...
    (avy-background t)
    :config
    (set-face-attribute 'avy-lead-face nil :background "green2" :foreground "gray20")
    (set-face-attribute 'avy-lead-face-0 nil :background "green2" :foreground "gray20")
    (set-face-attribute 'avy-lead-face-1 nil :background "green2" :foreground "gray20")
    (set-face-attribute 'avy-lead-face-2 nil :background "green2" :foreground "gray20")
    :bind
    ("C-s" . avy-goto-char)
    ("C-'" . avy-resume)
...
#+begin_src elisp
  (use-package lsp-mode
    ...
    ;; Ignore backup files and backup directory
    (add-to-list 'lsp-file-watch-ignored-files "[/\\\\].*~$")
    (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]\\.emacs\\.d/emacs-backup\\'")
    :hook
    ;; go
...
#+begin_src elisp
  (use-package claude-code :ensure t
    ...
    (my-leader-def "a" 'claude-code-transient)
    :custom
